...
func init() {
	...
	socketCreateCmd.Flags().StringVarP(&upstream_type, "upstream_type", "", "", "Upstream type: http, https for http socket or mysql, tls (mysql), postgres for database sockets")
